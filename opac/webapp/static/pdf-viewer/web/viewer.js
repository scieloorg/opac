...
var defaultOptions = {
  ...
  defaultUrl: {
    value: window.URLS_CONFIG.DOCUMENT_PDF,
  ...
  imageResourcesPath: {
    value: window.URLS_CONFIG.IMAGE_RESOURCES_PATH,
    kind: OptionKind.VIEWER
  },
  maxCanvasPixels: {
    value: 16777216,
  ...
  cMapUrl: {
    value: window.URLS_CONFIG.C_MAP_URL,
    kind: OptionKind.API
  },
  disableAutoFetch: {
    value: false,
  ...
  workerSrc: {
    value: window.URLS_CONFIG.WORKER_SRC,
    kind: OptionKind.WORKER
  }
};
{
