...
from webapp.config.lang_names import get_original_lang_name, display_original_lang_name
...
class LangNamesTestCase(BaseTestCase):
    ...
    def test_get_original_lang_name(self):
        ...
        self.assertEqual(get_original_lang_name('zh'), u'中文 (Zhōngwén), 汉语, 漢語')
        self.assertEqual(get_original_lang_name('ar'), u'العربية')
    ...
    def test_display_original_lang_name(self):
        ...
        self.assertEqual(display_original_lang_name('zh'), u'中文 (zhōngwén)')
        self.assertEqual(display_original_lang_name('ar'), u'العربية')
