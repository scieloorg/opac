...
class UtilsGScholarTestCase(BaseTestCase):
    ...
    def test_get_cited_and_related_article_urls(self):
        article_page_url = "http://www.scielo.br/scielo.php?pid=S0100-879X2004000400003&script=sci_arttext"
        titles = ["Genome features of Leptospira interrogans serovar Copenhageni"]
    ...
    def test_get_related_links(self):
        ...
        self.assertEqual("Google", result[0][0])
        self.assertEqual("Google Scholar", result[1][0])
        self.assertEqual("Similares no", result[0][1])
        self.assertEqual("Citados e Similares no", result[1][1])
        self.assertEqual(
            "https://www.google.com/search?q=Genome features of Leptospira interrogans serovar Copenhageni",
            result[0][2],
        )
        self.assertEqual(
            "https://scholar.google.com/scholar?q=Genome features of Leptospira interrogans serovar Copenhageni",
            result[1][2],
        )
